...
class BattleResultCSMessage(Writer):
    ...
    def encode(self):
        ...
        if self.player.tutorial <= 1:
            ...
            #DataBase.replaceValue(self, 'ppp', self.player.ppp + gainedtrophies)
#            DataBase.replaceValue(self, 'ppg', self.player.ppg + 1)
        ...
        self.writeVint(1) # Power Play Epic Points
        self.writeVint(15) # Championship Level Passed
        self.writeVint(0) # Challenge Reward Type (0 = Star Points, 1 = Star Tokens)
        self.writeVint(1500) # Challenge Reward Ammount
        self.writeVint(15) # Championship Losses Left
        self.writeVint(15) # Championship Maximun Losses
        ...
        self.writeVint(self.player.ppp) # Your Power Play Points
        ...
        self.writeString("ирлан дибил") # Bot 1 Name
        ...
        self.writeVint(1) # Brawler Power Level
        self.writeBoolean(False) # HighID and LowID Array
        self.writeString("(ЖМИХ) Леонардо") # Bot 2 Name
        self.writeVint(0) # Player Experience Level
        self.writeVint(28000000) # Player Profile Icon
        self.writeVint(43000000) # Player Name Color
        self.writeVint(0) # Unknown
        ...
        self.writeVint(1) # Brawler Power Level
        self.writeBoolean(False) # HighID and LowID Array
        self.writeString("poop man") # Bot 3 Name
        self.writeVint(0) # Player Experience Level
        self.writeVint(28000000) # Player Profile Icon
        self.writeVint(43000000) # Player Name Color
        self.writeVint(0) # Unknown
        ...
        self.writeVint(1) # Brawler Power Level
        self.writeBoolean(False) # HighID and LowID Array
        self.writeString("tiktoker") # Bot 4 Name
        self.writeVint(0) # Player Experience Level
        self.writeVint(28000000) # Player Profile Icon
        self.writeVint(43000000) # Player Name Color
        self.writeVint(0) # Unknown
        ...
        self.writeVint(1) # Brawler Power Level
        self.writeBoolean(False) # HighID and LowID Array
        self.writeString("sosy_jopy://") # Bot 5 Name
        self.writeVint(0) # Player Experience Level
        self.writeVint(28000000) # Player Profile Icon
        self.writeVint(43000000) # Player Name Color
        self.writeVint(0) # Unknown
       ...
       # self.player.pointsanimation = gainedtrophies
        if 16 <= result <= 23:
